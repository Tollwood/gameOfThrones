...
const castleBlack = new Area(0, "Castle Black", 1, false, false, false, 0);
const karhold = new Area(1, "Karhold", 1, false, false, false, 0);
const theShiveringSea = new Area(2, "The Shivering Sea", 0, false, false, false, 0);
const bayOfIce = new Area(3, "Bay of Ice", 0, false, false, false, 0);
const winterfell = new Area(4, "Winterfell", 1, true, false, true, 1);
const theStonyShore = new Area(5, "The Stony Shore", 1, false, false, false, 1);
const whiteHarbor = new Area(6, "White Harbor", 0, true, true, false, 0);
...
class Area {
    ...
    constructor(id: number, name: string, consolidatePower: number, harbor: boolean, castle: boolean, stronghold: boolean, supply: number) {
        this.name = name;
        this.id = id;
