...
export default class AssetManager {
  ...
  private static PATH_TO_IMAGE = 'src/assets/images/';
  ...
  public static loadAssets(game: Phaser.Game) {
    ...
    game.load.tilemap(this.GOT_TILE_MAP, 'src/assets/tilemap/gameOfThrones.json', null, Phaser.Tilemap.TILED_JSON);
