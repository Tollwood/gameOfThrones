...
export class AreaInitiator {
    ...
    public static getInitalState(): Array<Area> {
        ...
        let castleBlack = new Area('CastleBlack', 1, false, false, false, 0);
        areas.push(castleBlack);
        let karhold = new Area('Karhold', 1, false, false, false, 0);
        areas.push(karhold);
        let theShiveringSea = new Area('TheShiveringSea', 0, false, false, false, 0, [new Unit(UnitType.Ship, House.stark)]);
        areas.push(theShiveringSea);
        let bayOfIce = new Area('BayOfIce', 0, false, false, false, 0);
        areas.push(bayOfIce);
        let winterfell = new Area('Winterfell', 1, true, false, true, 1, [new Unit(UnitType.Horse, House.stark), new Unit(UnitType.Footman, House.stark)]);
        areas.push(winterfell);
        let theStonyShore = new Area('TheStonyShore', 1, false, false, false, 1);
        areas.push(theStonyShore);
        let whiteHarbor = new Area('WhiteHarbor', 0, true, true, false, 0, [new Unit(UnitType.Footman, House.stark)]);
        areas.push(whiteHarbor);
        let widowsWatch = new Area('WidowsWatch', 0, false, false, false, 1, []);
        areas.push(widowsWatch);
        let flintsFinger = new Area('FlintsFinger', 0, false, true, false, 0, []);
        areas.push(flintsFinger);
        let pyke = new Area('Pyke', 1, true, false, true, 1, [new Unit(UnitType.Footman, House.greyjoy), new Unit(UnitType.Horse, House.greyjoy)]);
        areas.push(pyke);
        let greyWaterWatch = new Area('GrayWaterWatch', 0, false, false, false, 1, [new Unit(UnitType.Footman, House.greyjoy)]);
        areas.push(greyWaterWatch);
        let ironmansBay = new Area('IronmansBay', 0, false, false, false, 0, [new Unit(UnitType.Ship, House.greyjoy), new Unit(UnitType.Ship, House.greyjoy)]);
        areas.push(ironmansBay);
        let theNarrowSea = new Area('TheNarrowSea', 0, false, false, false, 0, []);
        areas.push(theNarrowSea);
        let moatCailin = new Area('MoatCailin', 0, false, true, false, 0, []);
        areas.push(moatCailin);
        let seagard = new Area('Seagard', 1, false, false, true, 1, []);
        areas.push(seagard);
        let theTwins = new Area('TheTwins', 1, false, false, false, 0, []);
        areas.push(theTwins);
        let theFingers = new Area('TheFingers', 0, false, false, false, 1, []);
        areas.push(theFingers);
        let theEyrie = new Area('TheEyrie', 1, false, true, false, 1, []);
        areas.push(theEyrie);
        let sunsetSea = new Area('SunsetSea', 0, false, false, false, 0, []);
        areas.push(sunsetSea);
        let lannisport = new Area('Lannisport', 0, true, false, true, 2, [new Unit(UnitType.Footman, House.lannister), new Unit(UnitType.Horse, House.lannister)]);
        areas.push(lannisport);
        let theGoldenSound = new Area('TheGoldenSound', 0, false, false, false, 0, [new Unit(UnitType.Ship, House.lannister)]);
        areas.push(theGoldenSound);
        let stoneySept = new Area('StoneySept', 1, false, false, false, 0, [new Unit(UnitType.Ship, House.lannister)]);
        areas.push(stoneySept);
        let riverrun = new Area('Riverrun', 1, false, false, true, 1, []);
        areas.push(riverrun);
        let theMountainOfTheMoon = new Area('TheMountainOfTheMoon', 0, false, false, false, 1, []);
        areas.push(theMountainOfTheMoon);
        let harrenhal = new Area('Harrenhal', 1, false, true, false, 0, []);
        areas.push(harrenhal);
        let craicklawPoint = new Area('CraicklawPoint', 0, false, true, false, 0, []);
        areas.push(craicklawPoint);
        let blackwaterBay = new Area('BlackwaterBay', 0, false, false, false, 0, []);
        areas.push(blackwaterBay);
        let dragonStone = new Area('Dragonstone', 1, true, false, true, 1, [new Unit(UnitType.Footman, House.baratheon), new Unit(UnitType.Horse, House.baratheon)]);
        areas.push(dragonStone);
        let shipbreakerBay = new Area('ShipbreakerBay', 0, false, false, false, 0, [new Unit(UnitType.Ship, House.baratheon), new Unit(UnitType.Ship, House.baratheon)]);
        areas.push(shipbreakerBay);
        let kingswood = new Area('Kingswood', 1, false, false, false, 1, [new Unit(UnitType.Footman, House.baratheon)]);
        areas.push(kingswood);
        let kingsLanding = new Area('KingsLanding', 2, false, false, false, 0, []);
        areas.push(kingsLanding);
        let blackwater = new Area('Blackwater', 0, false, false, false, 2, []);
        areas.push(blackwater);
        let searoadMarches = new Area('SearoadMarches', 0, false, false, false, 1, []);
        areas.push(searoadMarches);
        let highgarden = new Area('Highgarden', 0, false, false, true, 2, [new Unit(UnitType.Footman, House.tyrell), new Unit(UnitType.Horse, House.tyrell)]);
        areas.push(highgarden);
        let dornishMarches = new Area('DornishMarches', 1, false, false, false, 0, [new Unit(UnitType.Footman, House.tyrell)]);
        areas.push(dornishMarches);
        let redwyneStraights = new Area('RedwyneStraights', 0, false, false, false, 0, [new Unit(UnitType.Ship, House.tyrell)]);
        areas.push(redwyneStraights);
        let stormsEnd = new Area('StormsEnd', 0, true, true, false, 0, []);
        areas.push(stormsEnd);
        let theBoneway = new Area('TheBoneway', 1, false, false, false, 0, []);
        areas.push(theBoneway);
        let oldtown = new Area('Oldtown', 0, true, false, true, 0, []);
        areas.push(oldtown);
        let threeTowers = new Area('ThreeTowers', 0, false, false, false, 1, []);
        areas.push(threeTowers);
        let princesPass = new Area('PrincesPass', 1, false, false, false, 1, []);
        areas.push(princesPass);
        let yronwood = new Area('Yornwood', 0, false, true, false, 0, []);
        areas.push(yronwood);
        let sunspear = new Area('Sunspear', 1, true, false, true, 1, [new Unit(UnitType.Footman, House.martell), new Unit(UnitType.Horse, House.martell)]);
        areas.push(sunspear);
        let saltShore = new Area('SaltShore', 0, false, false, false, 1, [new Unit(UnitType.Footman, House.martell)]);
        areas.push(saltShore);
        let seaOfDorne = new Area('SeaOfDorne', 0, false, false, false, 0, [new Unit(UnitType.Ship, House.martell)]);
        areas.push(seaOfDorne);
        let starfall = new Area('Starfall', 0, false, true, false, 1, []);
        areas.push(starfall);
        let theArbor = new Area('TheArbor', 1, false, false, false, 0, []);
        areas.push(theArbor);
        let westSummerSea = new Area('WestSummerSea', 0, false, false, false, 0, []);
        areas.push(westSummerSea);
        let eastSummerSea = new Area('EastSummerSea', 0, false, false, false, 0, []);
        areas.push(eastSummerSea);
        let theReach = new Area('TheReach', 0, false, true, false, 0, []);
        areas.push(theReach);
