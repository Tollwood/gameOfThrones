...
export class AreaInitiator {
    ...
    public static getInitalState(players: Array<Player>): Array<Area> {
        ...
        let cracklawPoint = new Area('CracklawPoint', 0, false, true, false, true, 0);
        areas.push(cracklawPoint);
        ...
        theNarrowSea.borders.push(theShiveringSea, widowsWatch, whiteHarbor, moatCailin, theTwins, theFingers, TheMountainsOfTheMoon, theEyrie, cracklawPoint, shipbreakerBay);
        ...
        TheMountainsOfTheMoon.borders.push(theTwins, theFingers, theNarrowSea, theEyrie, cracklawPoint);
        ...
        harrenhal.borders.push(cracklawPoint, blackwater, stoneySept, riverrun);
        cracklawPoint.borders.push(TheMountainsOfTheMoon, theNarrowSea, shipbreakerBay, blackwaterBay, kingsLanding, blackwater, harrenhal);
        shipbreakerBay.borders.push(theNarrowSea, dragonStone, eastSummerSea, stormsEnd, kingswood, blackwaterBay, cracklawPoint);
        dragonStone.borders.push(shipbreakerBay);
        kingsLanding.borders.push(cracklawPoint, blackwaterBay, kingswood, blackwater, theReach);
        blackwater.borders.push(harrenhal, cracklawPoint, kingsLanding, theReach, searoadMarches, stoneySept);
