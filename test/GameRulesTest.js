...
describe('GameRules', function () {
    ...
    it('should end the planningPhase the panning Phase while there are still Tokens to place', function () {
        gameStati_1.default.getInstance().areas.map(function (area) {
            area.orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        });
    ...
    it('should move units from one area to another', function () {
        gameRules_1.default.getAreaByKey('Winterfell').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.moveUnits('Winterfell', 'Karhold', new units_1.Unit(units_1.UnitType.Footman, house_1.House.stark));
    ...
    it('should move land units from one area to another over the sea using a friendly ship', function () {
        gameRules_1.default.getAreaByKey('WhiteHarbor').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.moveUnits('WhiteHarbor', 'CastleBlack', new units_1.Unit(units_1.UnitType.Footman, house_1.House.stark));
    ...
    it('should not move unit if unit is not present in source area ', function () {
        gameRules_1.default.getAreaByKey('Winterfell').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.moveUnits('Winterfell', 'Karhold', new units_1.Unit(units_1.UnitType.Siege, house_1.House.stark));
        var winterfell = gameRules_1.default.getAreaByKey('Winterfell');
        expect(winterfell.orderToken).toBeDefined();
    });
    it('should not move unit into an enemy area ', function () {
        gameRules_1.default.getAreaByKey('Winterfell').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.getAreaByKey('Karhold').units.push(new units_1.Unit(units_1.UnitType.Horse, house_1.House.baratheon));
        gameRules_1.default.moveUnits('Winterfell', 'Karhold', new units_1.Unit(units_1.UnitType.Footman, house_1.House.stark));
        var winterfell = gameRules_1.default.getAreaByKey('Winterfell');
        expect(winterfell.orderToken).toBeDefined();
    });
    it('should not move land unit into a sea area ', function () {
        gameRules_1.default.getAreaByKey('Winterfell').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.moveUnits('Winterfell', 'TheShiveringSea', new units_1.Unit(units_1.UnitType.Footman, house_1.House.stark));
        var winterfell = gameRules_1.default.getAreaByKey('Winterfell');
        expect(winterfell.orderToken).toBeDefined();
    });
    it('should not move sea unit into a land area ', function () {
        gameRules_1.default.getAreaByKey('TheShiveringSea').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.moveUnits('TheShiveringSea', 'Winterfell', new units_1.Unit(units_1.UnitType.Ship, house_1.House.stark));
    ...
    it('should not move units from one area to another if areas are not adjacent', function () {
        var winterfell = gameRules_1.default.getAreaByKey('Winterfell');
        gameRules_1.default.getAreaByKey('Winterfell').orderToken = new orderToken_1.OrderToken(house_1.House.stark, orderToken_1.OrderTokenType.march);
        gameRules_1.default.moveUnits('Winterfell', 'Starfall', new units_1.Unit(units_1.UnitType.Footman, house_1.House.stark));
