...
export default class BoardRenderer {
  ...
  public static renderBoard(renderer: Renderer) {
    const gameboard = renderer.game.add.sprite(0, 0, AssetLoader.GAME_BOARD, renderer.map);
    renderer.game.world.setBounds(gameboard.x, gameboard.y, gameboard.width, gameboard.height);
  }
